...
<body>	
	...
	<form onsubmit="myfun()" class="forumm" method="post" id="reg" action="newreg.php">
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		var chkenroll=document.getElementById("chkenroll");
		var forenroll =new RegExp(/^[0-9]+[A-Z]+[0-9]+$/);
...
if($conn)
{
	...
	if(mysqli_query($conn,$query1))
	{
		...
		if($check==0)
		{
			...
			$query="INSERT INTO `userreg` (`id`, `username`, `fname`, `email`, `phone`, `enroll`, `branch_and_year`, `pass`, `date`) VALUES ('$id','$uname','$fname','$email','$ph','$enroll','$bandy','$pass','$date')";
